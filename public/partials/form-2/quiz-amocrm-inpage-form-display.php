<div class="quiz-amocrm-inpage quiz-amocrm-inpage--extended">

  <!-- Какие черновые работы нужно выполнить? -->
  <section class="l-section wpb_row height_auto">
    <div class="l-section-h i-cf">
      <div class="g-cols vc_row via_flex valign_top type_default stacking_default">
        <div class="vc_col-sm-2 vc_hidden-sm vc_hidden-xs wpb_column vc_column_container hide_on_tablets hide_on_mobiles"></div>
        <div class="vc_col-sm-8 wpb_column vc_column_container">
          <div class="vc_column-inner">
            <div class="wpb_wrapper">
              <div class="w-separator size_medium"></div>
              <div class="wpb_text_column">
                <div class="wpb_wrapper"><h2 style="text-align: center;">Расчет стоимости <span
                      style="color: #1b98e0;">ОНЛАЙН</span></h2>
                </div>
              </div>
              <div
                class="w-separator us_custom_c097cd2b size_small with_line width_default thick_3 style_dotted color_primary align_center with_content">
                <div class="w-separator-h"><i class="fas fa-arrow-circle-down"></i></div>
              </div>
              <div class="w-separator size_medium"></div>
              <div class="wpb_text_column">
                <div class="wpb_wrapper"><h4 style="text-align: center;">Какие <span
                      style="color: #1b98e0;">черновые работы</span> нужно выполнить?</h4>
                </div>
              </div>
  ...
  <section class="l-section wpb_row height_auto color_primary with_shape">
    ...
    <div class="l-section-shape type_triangle-inv pos_top" style="visibility: hidden; position:relative;">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 8" preserveAspectRatio="none" width="100%" height="100%">
        <path fill="currentColor" d="M64 9 L0 9 L0 7.9 L32 0 L64 7.9 Z"></path>
      </svg>
    </div>
        ...
        <div class="vc_col-sm-8 wpb_column vc_column_container">
          <div class="vc_column-inner">
            <div class="wpb_wrapper">
              ...
              <div class="w-separator us_custom_532377d0 size_medium"></div>
              <div class="wpb_text_column">
                <div class="wpb_wrapper"><h4 style="text-align: center;">Укажите высоту до потолка Вашего объекта, м</h4>
                </div>
              </div>
              <div class="quiz-amocrm-inpage__w-form quiz-amocrm-inpage__w-form--extented layout_ver for_cform" style="--fields-gap:1.5rem">
                <div class="w-form-h">
                  <div class="w-form-row for_text has_label cols_1">
                    <div class="w-form-row-field">
                      <input class="quiz-amocrm-inpage__m3" aria-label="Укажите площадь по полу Вашего объекта, м2" type="number" min="1" name="ceiling_height" value="">
                    </div>
                  </div>
                </div>
  ...
  <section class="l-section wpb_row height_auto color_secondary with_shape">
    <div class="l-section-shape type_triangle-inv pos_top" style="color:var(--color-header-middle-text-hover)">
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 8" preserveAspectRatio="none" width="100%" height="100%">
        <path fill="currentColor" d="M64 9 L0 9 L0 7.9 L32 0 L64 7.9 Z"></path>
      </svg>
    </div>
        ...
        <div class="vc_col-sm-8 wpb_column vc_column_container">
          <div class="vc_column-inner">
            <div class="wpb_wrapper">
              ...
              <div class="quiz-amocrm-inpage__w-form quiz-amocrm-inpage__w-form--extented us_custom_de1be817 layout_ver for_cform" style="--fields-gap:1.5rem">
                <div class="w-form-h">
                  <div class="w-form-row for_text has_label cols_1">
<!--                    <div class="w-form-row-label">-->
<!--                      <span>Укажите площадь по полу Вашего объекта, м2</span>-->
<!--                    </div>-->
                    <div class="w-form-row-field">
                      <input class="quiz-amocrm-inpage__m3" aria-label="Укажите площадь по полу Вашего объекта, м2" type="number" min="1" name="floor_area" value="">
                    </div>
                  </div>
                  <div class="w-form-row cols_1 quiz-amocrm-inpage__title-prices" style="font-size: 24px;font-weight: 600;text-align: center;margin-top: 30px;">
                    Предварительный расчет стоимости работ:
                  </div>

                  <div class="w-form-row cols_1 quiz-amocrm-inpage__prices">
                  ...
                  <div class="w-form-row cols_1 quiz-amocrm-inpage__btn-submit-container">
                    <div class="quiz-amocrm-inpage__btn-submit quiz-amocrm-form__btn-submit" style="display:none;">
                      Оставить заявку для расчета полной стоимости
                      <br>
                      (РАБОТА + МАТЕРИАЛ)
                    </div>
                    <div id="quiz-amocrm-inpage-extended__send" style="display:none;"></div>
                  </div>
              </div>
            </div>
              <div class="w-separator us_custom_532377d0 size_medium"></div>
  ...
  [us_popup show_on="selector" trigger_selector="#quiz-amocrm-inpage-extended__send"]

  <div class="quiz-amocrm-send-form--extended">

    <div class="quiz-amocrm__title">
      При заказе пакета "черновые работы" инсталляция Aquatek в подарок
    </div>

    <form class="quiz-amocrm-form">
      <div class="quiz-amocrm-form__field">
        <label class="quiz-amocrm-form__label" for="qa-f-firstname-inpage-extended">Введите имя</label><input
          class="quiz-amocrm-form__input" id="qa-f-firstname-inpage-extended" type="text">
      </div>
      <div class="quiz-amocrm-form__field">
        <label class="quiz-amocrm-form__label" for="qa-f-phone-inpage-extended">Введите телефон</label><input
          class="quiz-amocrm-form__input" id="qa-f-phone-inpage-extended" data-type="phone" type="text">
      </div>
