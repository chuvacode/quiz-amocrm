<div class="quiz-amocrm-inpage quiz-amocrm-finishing">
                        ...
                        <div class="wpb_wrapper">
                            ...
                            <div class="wpb_text_column">
                                <div class="wpb_wrapper"><h4 style="text-align: center;">Какие <span
                                            style="color: #1b98e0;">чистовые материалы</span> необходимы?</h4>
                                </div>
                            </div>
                            ...
                            <div class="answer-variants">
                                <div class="variant-select answer-variants__variant-select">
                                    ...
                                    <div class="variant-select__text">Обои</div>
                                </div>
                                <div class="variant-select answer-variants__variant-select">
                                    <div class="variant-select__checkbox"></div>
                                    <div class="variant-select__text">Ламинат</div>
                                </div>
                                <div class="variant-select answer-variants__variant-select">
                                    <div class="variant-select__checkbox"></div>
                                    <div class="variant-select__text">Плинтус</div>
                                </div>
                                <div class="variant-select answer-variants__variant-select">
                                    <div class="variant-select__checkbox"></div>
                                    <div class="variant-select__text">Плитка</div>
                                </div>
                                <div class="variant-select answer-variants__variant-select">
                                    <div class="variant-select__checkbox"></div>
                                    <div class="variant-select__text">Розетки, выключатели и пр.</div>
                                </div>
                            </div>
  ...
  [us_popup show_on="selector" trigger_selector="#quiz-amocrm-material__send"]
